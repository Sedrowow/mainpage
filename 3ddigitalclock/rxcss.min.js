!(function (t, e) {
  ...
  return (function (t) {
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.subscribe = function (t, e, r) {
              ...
              if (
                (n ? n.call(i, this.source) : i.add(this._subscribe(i)),
                ...
                if ("object" == typeof r) {
                  r instanceof e
                    ...
                    : ((this.syncErrorThrowable = !0),
                      (this.destination = new a(this, r)));
                  break;
                }
              default:
                (this.syncErrorThrowable = !0),
                  (this.destination = new a(this, r, n, o));
            }
          }
          return (
            n(e, t),
        ...
        function e(e, r, n, i) {
          ...
          o.isFunction(r)
            ...
            : r &&
              ...
              (n = r.error),
              (i = r.complete),
              o.isFunction(u.unsubscribe) && this.add(u.unsubscribe.bind(u)),
            ...
            if (!this.isStopped) {
              ...
              this._complete
                ? t.syncErrorThrowable
                  ? (this.__tryOrSetError(t, this._complete),
                    this.unsubscribe())
                  : (this.__tryOrUnsub(this._complete), this.unsubscribe())
                : this.unsubscribe();
            }
          }),
              ...
              if (!this.closed) {
                ...
                if (((this._subscriptions = null), u.isFunction(o))) {
                  ...
                  h === a.errorObject &&
                    ...
                    (t =
                      t ||
                      (a.errorObject.e instanceof f.UnsubscriptionError
                        ? n(a.errorObject.e.errors)
                        : [a.errorObject.e])));
                }
                if (i.isArray(p))
                  for (var l = -1, b = p.length; ++l < b; ) {
                    ...
                    if (s.isObject(y)) {
                      ...
                      if (h === a.errorObject) {
                        ...
                        d instanceof f.UnsubscriptionError
                          ? (t = t.concat(n(d.errors)))
                          : t.push(d);
                      }
                    }
                  }
    ...
    function (t, e, r) {
      ...
      var u =
        ...
        x = function t() {
          ...
          return {
            set: function (r, n) {
              return "object" !==
                ("undefined" == typeof r ? "undefined" : c(r)) || n
                ? "object" === ("undefined" == typeof n ? "undefined" : c(n))
                  ? Object.keys(n).forEach(function (o) {
                      t(e).set(r + "-" + o, n[o]);
                    })
                  : e.style.setProperty("--" + r, S(n))
      ...
      (s.set = function (t) {
        for (
          var e, r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1;
          o < r;
          o++
        )
          n[o - 1] = arguments[o];
          ...
          return (
            ...
            (e.dispatch = function (t) {
              ...
              return r >= n
                ? void o.complete()
                : (o.next(e[r]),
                  void (o.closed || ((t.index = r + 1), this.schedule(t))));
            }),
    ...
    function (t, e, r) {
      ...
      function o() {
        ...
        return (
          ...
          null === n && 1 === t.length
            ? t[0]
            : new i.ArrayObservable(t, n).lift(new s.MergeAllOperator(r))
        );
      }
      var i = r(10),
        s = r(36),
    ...
    function (t, e, r) {
      ...
      function n(t) {
        return (
          void 0 === t && (t = Number.POSITIVE_INFINITY), this.lift(new u(t))
        );
      }
      var o =
          (this && this.__extends) ||
        ...
        return (
          ...
          (e.prototype._next = function (t) {
            this.active < this.concurrent
              ? (this.active++, this.add(s.subscribeToResult(this, t)))
              : this.buffer.push(t);
          }),
          (e.prototype._complete = function () {
            (this.hasCompleted = !0),
        ...
        if (i.isArray(e)) {
          ...
          if (e && "function" == typeof e[a.$$iterator])
            ...
            if ("function" == typeof v.subscribe)
              return v.subscribe(new f.InnerSubscriber(t, r, n));
            h.error(
              new TypeError(
    ...
    function (t, e, r) {
      ...
      function n(t, e, r) {
        ...
        return t || e || r
          ? new o.Subscriber(t, e, r)
          : new o.Subscriber(s.empty);
      }
      var o = r(2),
        i = r(6),
        s = r(9);
